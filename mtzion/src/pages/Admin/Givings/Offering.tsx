    ...
    <div className="p-4">
      <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
        ...
        <div className="px-4 py-3 border-b bg-gray-50 flex items-center justify-between">
          <span className="text-sm font-semibold">Offering List</span>
          <div className="flex items-center gap-3">
            <div className="text-xs text-gray-600">Number of Payments: <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white">0</span></div>
